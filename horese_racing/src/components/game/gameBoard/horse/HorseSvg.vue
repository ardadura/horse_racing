<template>
  <div ref="horse" class="horse-running">
    <svg :style="{fill: horse.color}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="60px" height="39px" viewBox="0 0 213.825 213.825" style="enable-background:new 0 0 213.825 213.825;" xml:space="preserve">
  <g>
  ...
  methods:{
    ...
    moveHorse(){
      ...
      if(isFinished){
        ...
        console.log(this.$refs.horse.style.left = `${position + speed}px`)
